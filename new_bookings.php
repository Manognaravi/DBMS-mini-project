...
if(isset($_POST['submit']))
{
  ...
  $query->bindParam(':bid',$service,PDO::PARAM_STR);
                  ...
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" id="info_update">
                       <?php @include("update_booking.php");?>
                     </div>
                     <div class="modal-footer ">
                    ...
                    <tr>
                      ...
                      <td class=" text-center">
                        ...
                        <a href="#"  class="edit_data2 btn btn-purple rounded" id="<?php echo  ($row->ID); ?>" ><i class="mdi mdi-pencil-box-outline " aria-hidden="true" title="Take action"></i></a>
                         ...
                         <a href="#"  class="edit_data btn btn-sm btn-info" id="<?php echo  ($row->ID); ?>" ><i class="mdi mdi-pencil-box-outline " aria-hidden="true" title="Edit booking"></i>Edit booking</a>
